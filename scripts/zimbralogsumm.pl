...
GetOptions(
    ...
    "zimbra-received"          => \$opts{'zimbra-received'},
    "zimbra-delivered"         => \$opts{'zimbra-delivered'},
    "zimbra-forwarded"         => \$opts{'zimbra-forwarded'},
    "zimbra-deferred"          => \$opts{'zimbra-deferred'},
    "zimbra-bounced"           => \$opts{'zimbra-bounced'},
    "zimbra-rejected"          => \$opts{'zimbra-rejected'},
    "zimbra-reject-warning"    => \$opts{'zimbra-reject-warning'},
    "zimbra-held"              => \$opts{'zimbra-held'},
    "zimbra-discarded"         => \$opts{'zimbra-discarded'},
    "zimbra-bytes-received"    => \$opts{'zimbra-bytes-received'},
    "zimbra-bytes-delivered"   => \$opts{'zimbra-bytes-delivered'},
    "zimbra-senders"           => \$opts{'zimbra-senders'},
    "zimbra-sending-domains"   => \$opts{'zimbra-sending-domains'},
    "zimbra-recipients"        => \$opts{'zimbra-recipients'},
    "zimbra-recipient-domains" => \$opts{'zimbra-recipient-domains'},
...
if(defined($opts{'zimbra-received'})) {
    printf "%d\n", adj_int_units($msgsRcvd);
}
if(defined($opts{'zimbra-delivered'})) {
    printf "%d\n", adj_int_units($msgsDlvrd);
}
if(defined($opts{'zimbra-forwarded'})) {
    printf "%d\n", adj_int_units($msgsFwdd);
}
if(defined($opts{'zimbra-deferred'})) {
    printf "%d\n", adj_int_units($msgsDfrd);
}
if(defined($opts{'zimbra-bounced'})) {
    printf "%d\n", adj_int_units($msgsBncd);
}
if(defined($opts{'zimbra-rejected'})) {
    printf "%d\n", adj_int_units($msgsRjctd), $msgsRjctdPct;
}
if(defined($opts{'zimbra-reject-warning'})) {
    printf "%d\n", adj_int_units($msgsWrnd);
}
if(defined($opts{'zimbra-held'})) {
    printf "%d\n", adj_int_units($msgsHld);
}
if(defined($opts{'zimbra-discarded'})) {
    printf "%d\n", adj_int_units($msgsDscrdd), $msgsDscrddPct;
}
if(defined($opts{'zimbra-bytes-received'})) {
    printf "%d\n", adj_int_units($sizeRcvd);
}
if(defined($opts{'zimbra-bytes-delivered'})) {
    printf "%d\n", adj_int_units($sizeDlvrd);
}
if(defined($opts{'zimbra-senders'})) {
    printf "%d\n", adj_int_units($sendgUserCnt);
}
if(defined($opts{'zimbra-sending-domains'})) {
    printf "%d\n", adj_int_units($sendgDomCnt);
}
if(defined($opts{'zimbra-recipients'})) {
    printf "%d\n", adj_int_units($recipUserCnt);
}
if(defined($opts{'zimbra-recipient-domains'})) {
